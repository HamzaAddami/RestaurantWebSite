...
function Reviews (){
    return(
        <div class="min-w-screen min-h-screen bg-gray-50 flex items-center justify-center py-5 bg-[url('./Pictures/bg1.jpg')] bg-cover">
    <div class="w-full bg-white border-t border-b border-gray-200 px-5 py-16 md:py-24 text-gray-800 bg-[url('./Pictures/bg1.jpg')] bg-cover">
